abstract class Vectoriables{ //clase encargada del vector que opera sobre la ubicación del mouse
  ...
  void setDirection(){ //definir vector=1 respecto a la posición del mouse
    mouse = new PVector(); //inicializa el objetivo a partir de la posición del mouse
    mouse.set(mouseX-width/2, mouseY-height+15); //posición del mouse respecto al tirador (y distancia según su ejes)
